...
"""autogenerated by genpy from stonefish_ros/DVL.msg. Do not edit."""
import codecs
import sys
...
class DVL(genpy.Message):
  ...
  _type = "stonefish_ros/DVL"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Extracted from UUV Simulator:
...
"""
  ...
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','float64[9]','float64','stonefish_ros/DVLBeam[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = stonefish_ros.msg.DVLBeam()
        _x = val1
        start = end
        end += 32
