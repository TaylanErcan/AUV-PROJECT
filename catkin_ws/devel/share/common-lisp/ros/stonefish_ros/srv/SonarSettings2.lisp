...
(cl:defmethod cl:initialize-instance :after ((m <SonarSettings2-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SonarSettings2-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stonefish_ros-srv:<SonarSettings2-request> is deprecated: use stonefish_ros-srv:SonarSettings2-request instead.")))

(cl:ensure-generic-function 'range_min-val :lambda-list '(m))
(cl:defmethod range_min-val ((m <SonarSettings2-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-srv:range_min-val is deprecated.  Use stonefish_ros-srv:range_min instead.")
  (range_min m))

(cl:ensure-generic-function 'range_max-val :lambda-list '(m))
(cl:defmethod range_max-val ((m <SonarSettings2-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-srv:range_max-val is deprecated.  Use stonefish_ros-srv:range_max instead.")
  (range_max m))

(cl:ensure-generic-function 'rotation_min-val :lambda-list '(m))
(cl:defmethod rotation_min-val ((m <SonarSettings2-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-srv:rotation_min-val is deprecated.  Use stonefish_ros-srv:rotation_min instead.")
  (rotation_min m))

(cl:ensure-generic-function 'rotation_max-val :lambda-list '(m))
(cl:defmethod rotation_max-val ((m <SonarSettings2-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-srv:rotation_max-val is deprecated.  Use stonefish_ros-srv:rotation_max instead.")
  (rotation_max m))

(cl:ensure-generic-function 'gain-val :lambda-list '(m))
(cl:defmethod gain-val ((m <SonarSettings2-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-srv:gain-val is deprecated.  Use stonefish_ros-srv:gain instead.")
  (gain m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SonarSettings2-request>)))
  ...
  "stonefish_ros/SonarSettings2Request")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SonarSettings2-request)))
  "Returns string type for a service object of type 'SonarSettings2-request"
  "stonefish_ros/SonarSettings2Request")
...
(cl:defmethod cl:initialize-instance :after ((m <SonarSettings2-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SonarSettings2-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stonefish_ros-srv:<SonarSettings2-response> is deprecated: use stonefish_ros-srv:SonarSettings2-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SonarSettings2-response>)))
  ...
  "stonefish_ros/SonarSettings2Response")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SonarSettings2-response)))
  "Returns string type for a service object of type 'SonarSettings2-response"
  "stonefish_ros/SonarSettings2Response")
