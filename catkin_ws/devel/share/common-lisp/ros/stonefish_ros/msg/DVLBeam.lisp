...
(cl:defmethod cl:initialize-instance :after ((m <DVLBeam>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DVLBeam)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stonefish_ros-msg:<DVLBeam> is deprecated: use stonefish_ros-msg:DVLBeam instead.")))
...
(cl:defmethod range_covariance-val ((m <DVLBeam>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-msg:range_covariance-val is deprecated.  Use stonefish_ros-msg:range_covariance instead.")
  (range_covariance m))
