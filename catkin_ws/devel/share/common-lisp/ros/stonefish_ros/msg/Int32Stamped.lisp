...
(cl:defmethod cl:initialize-instance :after ((m <Int32Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int32Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stonefish_ros-msg:<Int32Stamped> is deprecated: use stonefish_ros-msg:Int32Stamped instead.")))
...
(cl:defmethod data-val ((m <Int32Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-msg:data-val is deprecated.  Use stonefish_ros-msg:data instead.")
  (data m))
