...
(cl:defclass <EventArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (events
    :reader events
    :initarg :events
    :type (cl:vector stonefish_ros-msg:Event)
   :initform (cl:make-array 0 :element-type 'stonefish_ros-msg:Event :initial-element (cl:make-instance 'stonefish_ros-msg:Event))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EventArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EventArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stonefish_ros-msg:<EventArray> is deprecated: use stonefish_ros-msg:EventArray instead.")))
...
(cl:defmethod height-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-msg:height-val is deprecated.  Use stonefish_ros-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-msg:width-val is deprecated.  Use stonefish_ros-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'events-val :lambda-list '(m))
(cl:defmethod events-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader stonefish_ros-msg:events-val is deprecated.  Use stonefish_ros-msg:events instead.")
  (events m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EventArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'events)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'stonefish_ros-msg:Event))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EventArray>)))
  ...
  (cl:format cl:nil "Header header~%uint32 height~%uint32 width~%Event[] events~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: stonefish_ros/Event~%uint16 x~%uint16 y~%time ts~%bool polarity~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EventArray)))
  "Returns full string definition for message of type 'EventArray"
  (cl:format cl:nil "Header header~%uint32 height~%uint32 width~%Event[] events~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: stonefish_ros/Event~%uint16 x~%uint16 y~%time ts~%bool polarity~%~%"))
